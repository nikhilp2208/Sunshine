...
// 60 seconds (1 minute)  180 = 3 hours
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        if(preferences.getBoolean(getContext().getString(R.string.pref_notification_key),true)) {
            notifyWeather();
        }
        return;
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()) {
            locationIndex = locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                Uri dateUri = WeatherContract.WeatherEntry.buildWeatherLocationWithDate(Utility.getPreferredLocation(context), System.currentTimeMillis());

                resultIntent.setData(dateUri);
