...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Error: No data was inserted",c.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)

        TestUtilities.validateCurrentRecord("Error: Data inserted doesn't match the expected",c,contentValues);

        assertFalse("Error: More than one record exists",c.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        assertFalse("Error: Location not inserted properly",locationRowId == -1L);
        ...
        assertFalse("Error: Inserting to db failed", weatherRowId == -1);
        ...
        TestUtilities.validateCurrentRecord("Error: Data inserted doesn't match expected values",c,contentValues);
